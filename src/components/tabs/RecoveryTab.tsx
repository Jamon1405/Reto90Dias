  ...
  return (
    <div className="space-y-4">
      <div className="grid gap-4 sm:grid-cols-3">
        <div>
          <label className="text-xs font-semibold text-text">Sauna (min)</label>
          <Input
            type="number"
        ...
        <div>
          <label className="text-xs font-semibold text-text">Vapor (min)</label>
          <Input
            type="number"
        ...
        <div>
          <label className="text-xs font-semibold text-text">Cold (min)</label>
          <Input
            type="number"
