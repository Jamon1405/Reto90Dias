  ...
  return (
    <div className="space-y-4">
      <div className="grid gap-4 sm:grid-cols-3">
        <div>
          <label className="text-xs font-semibold text-text">Proteína (g)</label>
          <Input
            type="number"
        ...
        <div>
          <label className="text-xs font-semibold text-text">Carbs (g)</label>
          <Input
            type="number"
        ...
        <div>
          <label className="text-xs font-semibold text-text">Grasa (g)</label>
          <Input
            type="number"
      ...
      <div className="rounded-md border border-border bg-surface px-3 py-2 text-sm">Cal IN: {calIn} kcal</div>
